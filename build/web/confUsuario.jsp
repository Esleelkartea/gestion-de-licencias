...
<div id="contenedor">
		...
		<li><a href="http://www.bizkaiagolf.com">WEB</a></li>
         ...
         <div id="submenu">
            <ul id="lista_submenu">
                        ...
                        <li><a id="activo" href="">Usuario</a></li>
            </ul>
	</div>
	...
	<h1><img src="imagenes/carpeta.gif" width="30" height="30" /> CONFIGURACI&Oacute;N USUARIOS</h1>
       

        <div class="marco">
  	<div class="msg_head_gris">
            <img src="imagenes/lapiz.gif" width="16" height="16" />Usuarios</div>
	...
	<tr>
        ...
        <th class="titulos_tablas">Usuario</th>
        <th class="titulos_tablas">Password</th>
        ...
        <tbody>
            ...
            %>
            <tr>
                <td class="texto_tablas"><a href="confUsuarioServlet?var=<%=listaUsuario.get(i).getIdCategoria()%>"><%=listaCategorias.get(i).getCodigo()%></a></td>
                <td class="texto_tablas"><a href="confUsuarioServlet?var=<%=listaUsuario.get(i).getIdCategoria()%>"><%=listaCategorias.get(i).getNomCastellano()%></a></td>
                <td class="texto_tablas"><a href="confUsuarioServlet?var=<%=listaUsuario.get(i).getIdCategoria()%>"><%=listaCategorias.get(i).getNomEuskera()%></a></td>
                <td class="texto_tablas"><a href="confUsuarioServlet?var=<%=listaUsuario.get(i).getIdCategoria()%>"><%=listaCategorias.get(i).getEdadMinima()%></a></td>
                <td class="texto_tablas"><a href="confUsuarioServlet?var=<%=listaUsuario.get(i).getIdCategoria()%>"><%=listaCategorias.get(i).getEdadMaxima()%></a></td>
            </tr>
