...
<div id="contenedor">
	...
	<h1><img src="imagenes/carpeta.gif" width="30" height="30" /> Busqueda Colectivo</h1>
       ...
       <%
           ...
           String idColectivo = (String)session.getAttribute("idColectivo");
       %>
	...
	<div class="formulario_dobles_campos">
        ...
        <form action="vincularColectivoMIBServlet" autocomplete="off" method="post" >


            <input type="hidden" name="idFederado" value="<%=unFederado.getIdFederado()%>" />
            <input type="hidden" name="idColectivo" value="<%=idColectivo%>" />

            <div class="formulario_botones">
               <label><input name="enviar" type="submit" class="boton" id="alta" value="Eliminar" ></label>
