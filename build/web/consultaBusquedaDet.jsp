...
<div id="contenedor">
	...
	<h1><img src="imagenes/carpeta.gif" width="30" height="30" /> CONSULTA</h1>
	...
	<div class="formulario_dobles_campos">
        ...
        <form action="consultaBusquedaMIBServlet" autocomplete="off" method="post" >
        ...
        <div class="formulario_formato">
            ...
            <div class="formulario_dobles">
                <%
                    if(unFederadoConsulta.isPendiente())
                    {
                %>
                <input type="checkbox" name="pendiente" id="pendiente" value="On"  checked /> Pendiente<br />
                <%
                    }
                    else
                    {
                %>
                    <input type="checkbox" name="pendiente" id="pendiente" value="On" /> Pendiente<br />
                <%
                    }
                %>
            </div>
                    ...
                    <select name="consulta" id="consulta">
                     ...
                     <%
                        if (listaConsultas != null)
                        {
                            ...
                            {
                                if(listaConsultas.get(i).getIdConsulta() == unFederadoConsulta.getConsulta().getIdConsulta())
                                {
                     %>
                                <option name="consulta" value="<%=listaConsultas.get(i).getIdConsulta()%>" selected ><%=listaConsultas.get(i).getConsulta()%></option>
                   <%
                                }
                                else
                                {
	...
	<div class="formulario_dobles_campos">
            <label><input name="fecha" type="text" class="campo_texto" id="f_date_y" readonly="1" value="<%=fecha%>" />
	...
	<div class="formulario_dobles_campos">
        ...
        <input type="hidden" name="idFederadoConsulta" value="<%=unFederadoConsulta.getIdFederadoConsulta()%>" />
        <input type="hidden" name="idFederado" value="<%=unFederadoConsulta.getFederado().getIdFederado()%>" />
