...
<link href="estilos/estilos.css" rel="stylesheet" type="text/css" />
 ...
 <script type="text/javascript">
    ...
    function validar()
    {
        nombreAccion = document.getElementById("accion").value;
        if (nombreAccion.length == 0)
        {
            alert("Debes introducir el nombre de la Accion");
            return false;
        }
        else
        {
    ...
    function validarBaja()
    {
        ...
        if (idAccion.length == 0 || idAccion == "/")
        {
            alert("Debes seleccionar una Accion para dar de baja");
            return false;
        }
        else
        {
...
<div id="contenedor">
	...
	<div id="menu">
		...
		<li><a href="http://www.bizkaiagolf.com">WEB</a></li>
         ...
         <div id="submenu">
            <ul id="lista_submenu">
                        <li><a id="activo" href="#">Acciones</a></li>
     ...
     <%
            ArrayList<Accion> listaAccion = (ArrayList<Accion>)session.getAttribute("listaAccion");
     %>

 	<div id="principal">

	<h1><img src="imagenes/carpeta.gif" width="30" height="30" /> CONFIGURACI&Oacute;N ACCIONES</h1>

   <div class="marco">
  		<div class="msg_head_gris">
                    <img src="imagenes/lapiz.gif" width="16" height="16" />Categor&iacute;as de Acciones
                </div>
	...
	<tbody>
            ...
            %>
            <tr>
                <td class="texto_tablas"><a href="confAccionServlet?var=<%=listaAccion.get(i).getIdAccion()%>"><%=listaAccion.get(i).getNombre()%></a></td>
            </tr>
        ...
        <%
        Accion unaAccion = (Accion)session.getAttribute("unaAccion");
        String idAccion = "";
        String nombre = "";

        if (unaAccion != null)
        {
            idAccion = String.valueOf(unaAccion.getIdAccion());
            nombre = unaAccion.getNombre();
        }
     %>

        <form autocomplete="off" action="confAccionMIBServlet" method="post">

	<div class="formulario_formato">
            <div class="formulario_dobles">Acci&oacute;n: </div>
	<div class="formulario_dobles_campos">
            <label><input name="accion" type="text" class="campo_texto" id="accion" size="100" value="<%=nombre%>" >
	</label></div>
	</div>

            <input type="hidden"  name="idAccion" id="idAccion" value=<%=idAccion%> /><br/>
