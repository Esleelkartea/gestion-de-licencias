...
<div id="contenedor">
	...
	<h1><img src="imagenes/carpeta.gif" width="30" height="30" /> Alta Colectivo </h1>
    	...
    	<img src="imagenes/lapiz.gif" width="16" height="16" />El Federado ya esta vinculado a ese Colectivo.</div>
  		<div class="msg_body_gris">
                    ...
                    <form autocomplete="off" action="vincularAltaResultadoServlet?var=<%=unFederado.getIdFederado()%>" method="post">
