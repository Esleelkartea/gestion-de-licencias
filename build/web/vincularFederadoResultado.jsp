    ...
    %>
               ...
               <div class="capas_tablas_mm">
                ...
                <tbody>
                    ...
                    %>
                    <tr>
                        <td class="texto_tablas"><a href="vincularBusqFederadoDetServlet?var=<%=listaFederadoColectivo.get(i).getIdFederadoColectivo()%>"><%=listaFederadoColectivo.get(i).getColectivo().getNombre()%></a></td>
                        <td class="texto_tablas"><a href="vincularBusqFederadoDetServlet?var=<%=listaFederadoColectivo.get(i).getIdFederadoColectivo()%>"><%=listaFederadoColectivo.get(i).getColectivo().getDescripcion()%></a></td>
                        <td class="texto_tablas"><a href="vincularBusqFederadoDetServlet?var=<%=listaFederadoColectivo.get(i).getIdFederadoColectivo()%>"><%=listaFederadoColectivo.get(i).getObservaciones()%></a></td>
                    </tr>
