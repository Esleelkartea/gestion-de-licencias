...
<link href="estilos/estilos.css" rel="stylesheet" type="text/css" />
 ...
 <script type="text/javascript">
    ...
    function validar()
    {
        ...
        if (titulo.length == 0)
        {
            alert("Debes introducir un titulo a la consulta");
            return false;
        }
        else
        {
            ...
            {
                alert("Debes introducir una descripcion a la Consulta");
                return false;
            }
            else
            {
    ...
    function validarBaja()
    {
        ...
        if (idConsulta.length == 0 || idConsulta == "/")
        {
            alert("Debes seleccionar una Consulta para dar de baja");
            return false;
        }
        else
        {
...
<div id="contenedor">
		...
		<li><a href="http://www.bizkaiagolf.com">WEB</a></li>
         ...
         <div id="submenu">
            <ul id="lista_submenu">
                        ...
                        <li><a id="activo" href="">Consultas</a></li>
	...
	<h1><img src="imagenes/carpeta.gif" width="30" height="30" /> CONFIGURACI&Oacute;N CONSULTAS</h1>
     

           <div class="marco">
  		<div class="msg_head_gris">
    	<img src="imagenes/lapiz.gif" width="16" height="16" />Consultas</div>
	...
	<tr>
            <th class="titulos_tablas">Titulo</th>
            <th class="titulos_tablas">Descripcion Consulta</th>
        </tr>
	</thead>
        ...
        <tbody>
            ...
            %>
            <tr>
                <td class="texto_tablas"><a href="confConsultaServlet?var=<%=listaConsultas.get(i).getIdConsulta()%>"><%=listaConsultas.get(i).getConsulta()%></a></td>
                <td class="texto_tablas"><a href="confConsultaServlet?var=<%=listaConsultas.get(i).getIdConsulta()%>"><%=listaConsultas.get(i).getDescripcion()%></a></td>
            </tr> 
        ...
        <%
        Consulta unaConsulta = (Consulta)session.getAttribute("unaConsulta");
        String idConsulta = "";
        String titulo = "";
        String descripcion = "";
        ...
        if (unaConsulta != null)
        {
            idConsulta = String.valueOf(unaConsulta.getIdConsulta());
            titulo = unaConsulta.getConsulta();
            descripcion = unaConsulta.getDescripcion();
        }
       %>

       <form autocomplete="off" action="confConsultaMIBServlet" method="post">
           
	<div class="formulario_formato">
	<div class="formulario_dobles">Titulo: </div>
	<div class="formulario_dobles_campos">
            <label><input name="nombre" type="text" class="campo_texto" id="nombre" size="100" value="<%=titulo%>" >
	</label></div>
	</div>
	...
	<div class="formulario_dobles_campos">
            ...
            <input type="hidden" id="idConsulta"  name="idConsulta" value=<%=idConsulta%> /><br/>
