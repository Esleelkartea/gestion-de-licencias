...
<div id="contenedor">
	...
	<h1><img src="imagenes/carpeta.gif" width="30" height="30" /> Busqueda Colectivo </h1>
    	...
    	<img src="imagenes/lapiz.gif" width="16" height="16" />La Eliminacion se ha realizado correctamente.</div>
  		<div class="msg_body_gris">

                  <form autocomplete="off" action="vincularBusquedaServlet" method="post">
