...
<div id="contenedor">
	...
	<h1><img src="imagenes/carpeta.gif" width="30" height="30" /> Busqueda Bajas</h1>
    	...
    	<img src="imagenes/lapiz.gif" width="16" height="16" />Bajas de Federado</div>
	...
	<tr>
            ...
            <th class="titulos_tablas">Fecha Baja</th>
            <th class="titulos_tablas">Razon Baja</th>
        </tr>
	</thead>
        ...
        <tbody>
            ...
            <% if (listaFederados != null)
               {
                ...
                TipoBajaDAL tipoBajaDAL = new TipoBajaDAL();
                    ...
                    {
                        fecha = String.valueOf(listaFederados.get(i).getFechaBaja());
            ...
            <tr>
                ...
                <td class="texto_tablas"><%=unTipoBaja.getRazon()%></td>
            </tr> 
       ...
       <form autocomplete="off" action="excelBajas.jsp" method="post">
