...
<%@page import="com.Negocio.Perfil"%>
...
<link href="estilos/estilos.css" rel="stylesheet" type="text/css" />
 ...
 <script type="text/javascript">
    ...
    function validar()
    {
        ...
        if (nombre.length == 0)
        {
            alert("Debes introducir un Nombre al Perfil");
            return false;
        }
        else
        {
            ...
            {
                alert("Debes introducir una descripcion al Perfil");
                return false;
            }
            else
            {
    ...
    function validarBaja()
    {
        ...
        if (idPerfil.length == 0 || idPerfil == "/")
        {
            alert("Debes seleccionar un Perfil para dar de baja");
            return false;
        }
        else
        {
...
<div id="contenedor">
	...
	<div id="menu">
		...
		<li><a href="http://www.bizkaiagolf.com">WEB</a></li>
         ...
         <div id="submenu">
            <ul id="lista_submenu">
                        ...
                        <li><a id="activo" href="#">Perfiles</a></li>
     ...
     <%
            ArrayList<Perfil> listaPerfiles = (ArrayList<Perfil>)session.getAttribute("listaPerfiles");
     %>

 	<div id="principal">

	<h1><img src="imagenes/carpeta.gif" width="30" height="30" /> CONFIGURACI&Oacute;N PERFILES</h1>
     

           <div class="marco">
  		<div class="msg_head_gris">
    	<img src="imagenes/lapiz.gif" width="16" height="16" />Perfiles</div>
	...
	<tr>
            <th class="titulos_tablas">Nombre Perfil</th>
            <th class="titulos_tablas">Descripcion Perfil</th>
        </tr>
	</thead>
        ...
        <tbody>
            ...
            %>
            <tr>
                <td class="texto_tablas"><a href="confPerfilServlet?var=<%=listaPerfiles.get(i).getIdPerfil()%>"><%=listaPerfiles.get(i).getNombre()%></a></td>
                <td class="texto_tablas"><a href="confPerfilServlet?var=<%=listaPerfiles.get(i).getIdPerfil()%>"><%=listaPerfiles.get(i).getDescripcion()%></a></td>
            </tr> 
        ...
        <%
        Perfil unPerfil = (Perfil)session.getAttribute("unPerfil");
        String idPerfil = "";
        String nombre = "";
        String descripcion = "";
        ...
        if (unPerfil != null)
        {
            idPerfil = String.valueOf(unPerfil.getIdPerfil());
            nombre = unPerfil.getNombre();
            descripcion = unPerfil.getDescripcion();
        }
       %>

       <form autocomplete="off" action="confPerfilMIBServlet" method="post">
	...
	<div class="formulario_dobles_campos">
            ...
            <input type="hidden" id="idPerfil"  name="idPerfil" value=<%=idPerfil%> /><br/>
