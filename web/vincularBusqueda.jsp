...
<div id="contenedor">
	...
	<h1><img src="imagenes/carpeta.gif" width="30" height="30" /> Busqueda Vinculacion Colectivo</h1>
     
             <div class="marco">
  		<div class="msg_head_gris">
    	<img src="imagenes/lapiz.gif" width="16" height="16" />Selecciona el tipo de busqueda a realizar</div>
  		<div class="msg_body_gris">

                   

            <form autocomplete="off" action="vincularBusquedaTipoServlet" method="post">
       
                <div class="formulario_botones">
                    <label><input name="enviar" type="submit" class="boton" id="alta" value="COLECTIVO"></label>
                    <label><input name="enviar" type="submit" class="boton" id="alta" value="FEDERADO"></label>
                </div>
            </form>
