...
<link href="estilos/estilos.css" rel="stylesheet" type="text/css" />
 ...
 <script type="text/javascript">
    ...
    function validar()
    {
        ...
        {
            alert("Debes introducir el nombre del Parentesco");
            return false;
        }
        else
        {
    ...
    {
        idTipoFamiliar = document.getElementById("idTipoFamiliar").value;
        if (idTipoFamiliar.length == 0 || idTipoFamiliar == "/")
        {
            alert("Debes seleccionar una Parentesco para dar de baja");
            return false;
        }
        else
        {
...
<div id="contenedor">
		...
		<li><a href="http://www.bizkaiagolf.com">WEB</a></li>
         ...
         <div id="submenu">
            <ul id="lista_submenu">
                        ...
                        <li><a id="activo" href="#">Parentescos</a></li>
	...
	<h1><img src="imagenes/carpeta.gif" width="30" height="30" /> CONFIGURACI&Oacute;N PARENTESCO</h1>
	...
	<tbody>
            ...
            %>
            <tr>
                <td class="texto_tablas"><a href="confParentescoServlet?var=<%=listaTipoFamiliar.get(i).getIdTipoFamiliar()%>"><%=listaTipoFamiliar.get(i).getNombre()%></a></td>
            </tr>
         ...
         <%
        TipoFamiliar tipoFamiliar = (TipoFamiliar)session.getAttribute("unTipoFamiliar");
        ...
        if (tipoFamiliar != null)
        {
            ...
            nombre = tipoFamiliar.getNombre();
        }
        %>

        <form autocomplete="off" action="confParentescoMIBServlet" method="post">

	<div class="formulario_formato">
	<div class="formulario_dobles">Parentesco: </div>
	<div class="formulario_dobles_campos">
            <label><input name="parentesco" type="text" class="campo_texto" id="parentesco" size="100" value="<%=nombre%>" >
	</label></div>
	</div>

            <input type="hidden" id="idTipoFamiliar"  name="idTipoFamiliar" value=<%=idTipoFamiliar%> /><br/>
