...
<%@page import="com.Negocio.PlantillaCarta"%>
...
<link href="estilos/estilos.css" rel="stylesheet" type="text/css" />
 ...
 <script type="text/javascript">
    ...
    function validar()
    {
        ...
        if (nombre.length == 0)
        {
            alert("Debes introducir el nombre de la Plantilla Carta");
            return false;
        }
        else
        {
            if (texto.length == 0)
            {
                alert("Debes introducir el texto de la Plantilla Carta");
                return false;
            }
            else
            {
    ...
    {
        idPlantillaCarta = document.getElementById("idPlantillaCarta").value;
        if (idPlantillaCarta.length == 0 || idPlantillaCarta == "/")
        {
...
<div id="contenedor">
	...
	<div id="menu">
		...
		<li><a href="http://www.bizkaiagolf.com">WEB</a></li>
         ...
         <div id="submenu">
            <ul id="lista_submenu">
                        ...
                        <li><a id="activo" href="#">Plantilla carta</a></li>
        ...
        <%
            ArrayList<PlantillaCarta> listaPlantillaCarta = (ArrayList<PlantillaCarta>)session.getAttribute("listaPlantillaCarta");
        %>

 	<div id="principal">

	<h1><img src="imagenes/carpeta.gif" width="30" height="30" /> CONFIGURACI&Oacute;N PLANTILLAS CARTA</h1>


          <div class="marco">
  		<div class="msg_head_gris">
    	<img src="imagenes/lapiz.gif" width="16" height="16" />Gesti&oacute;n de Plantillas de Carta (Tipos de Cartas)</div>
	...
	<tr>
          ...
          <tbody>
            ...
            <% if (listaPlantillaCarta != null)
               {
                    for (int i = 0; i<listaPlantillaCarta.size(); i++)
                    {
            %>
            <tr>
                <td class="texto_tablas"><a href="confPlantillaCartaServlet?var=<%=listaPlantillaCarta.get(i).getIdPlantillaCarta()%>"><%=listaPlantillaCarta.get(i).getNombre()%></a></td>
                <td class="texto_tablas"><a href="confPlantillaCartaServlet?var=<%=listaPlantillaCarta.get(i).getIdPlantillaCarta()%>"><%=listaPlantillaCarta.get(i).getFichero()%></a></td>
            </tr>
        ...
        <%
            PlantillaCarta unaPlantillaCarta = (PlantillaCarta)session.getAttribute("unaPlantillaCarta");
            String idPlantillaCarta = "";
            String nombre = "";
            String archivo = "";
            if (unaPlantillaCarta != null)
            {
                idPlantillaCarta = String.valueOf(unaPlantillaCarta.getIdPlantillaCarta());
                nombre = unaPlantillaCarta.getNombre();
                archivo = unaPlantillaCarta.getFichero();
            }
        %>


        <form autocomplete="off" action="confPlantillaCartaMIBServlet" method="post">
	...
	<div class="formulario_dobles_campos">
            ...
            <input type="hidden" id="idPlantillaCarta"  name="idPlantillaCarta" value=<%=idPlantillaCarta%> /><br/>
	...
	<div class="formulario_botones">
        ...
        <form autocomplete="off" action="confPlantillaCartaAlta.jsp" method="post">
        <div class="formulario_formato">
        <div class="formulario_botones">
