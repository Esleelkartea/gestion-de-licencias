...
<link href="estilos/estilos.css" rel="stylesheet" type="text/css" />
 ...
 <script type="text/javascript">
    ...
    function validar()
    {
        var tipoTelefono = document.getElementById("tipo").value;
        if (tipoTelefono.length == 0)
        {
            alert("Debes introducir un Tipo de Telefono");
            return false;
        }
        else
        {
    ...
    {
        var idTipoTelefono = document.getElementById("idTipoTelefono").value;
        if (idTipoTelefono.length == 0 || idTipoTelefono == "/")
        {
            alert("Debes seleccionar un Tipo de Telefono para dar de baja");
            return false;
        }
        else
        {
...
<div id="contenedor">
		...
		<li><a href="http://www.bizkaiagolf.com">WEB</a></li>
         ...
         <div id="submenu">
            <ul id="lista_submenu">
                        ...
                        <li><a id="activo" href="#">Tipo telefono</a></li>
            </ul>
	</div>
	...
	<h1><img src="imagenes/carpeta.gif" width="30" height="30" /> CONFIGURACI&Oacute;N TIPOS TELEFONO</h1>
     

           <div class="marco">
  		<div class="msg_head_gris">
    	<img src="imagenes/lapiz.gif" width="16" height="16" />Tipos Telefono</div>
	...
	<tr>
            <th class="titulos_tablas">Tipo Telefono</th>
        </tr>
	</thead>
        ...
        <tbody>
            ...
            %>
            <tr>
                <td class="texto_tablas"><a href="confTipoTelefonoServlet?var=<%=listaTipoTelefono.get(i).getIdTipoTelefono()%>"><%=listaTipoTelefono.get(i).getTipo()%></a></td>
            </tr> 
        ...
        <%
        TipoTelefono unTipoTelefono = (TipoTelefono)session.getAttribute("unTipoTelefono");
        String idTipoTelefono = "";
        String tipo = "";

        if (unTipoTelefono != null)
        {
            idTipoTelefono = String.valueOf(unTipoTelefono.getIdTipoTelefono());
            tipo = unTipoTelefono.getTipo();
        }
       %>

       <form autocomplete="off" action="confTipoTelefonoMIBServlet" method="post">
           
	<div class="formulario_formato">
	<div class="formulario_dobles">Tipo Telefono: </div>
	<div class="formulario_dobles_campos">
            ...
            <input type="hidden" id="idTipoTelefono"  name="idTipoTelefono" value=<%=idTipoTelefono%> /><br/>
