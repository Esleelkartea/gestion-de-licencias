...
<div id="contenedor">
	...
	<div id="menu">
		...
		<li><a href="http://www.bizkaiagolf.com">WEB</a></li>
          ...
          <div id="submenu">
            <ul id="lista_submenu">
                        <li><a id="activo" href="#">Busqueda Pendiente</a></li>
            </ul>
	</div>
	...
	<h1><img src="imagenes/carpeta.gif" width="30" height="30" /> Busqueda Pendiente</h1>

        <form autocomplete="off" action="licenBusquedaPendiente2Servlet" method="post">
