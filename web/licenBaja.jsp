...
<div id="contenedor">
	...
	<h1><img src="imagenes/carpeta.gif" width="30" height="30" /> BAJA FEDERADO</h1>
        ...
        <form autocomplete="off" action="licenBajaBusquedaServlet" method="post">
    ...
    <%
       ...
       session.setAttribute("listaFederado", null);
    ...
    %>
               ...
               <div class="capas_tablas_mm">
                ...
                <tbody>
                    ...
                    %>
                    <tr>
                        <td class="texto_tablas"><a href="licenBajaResultadoServlet?var=<%=listaFederado.get(i).getIdFederado()%>"><%=listaFederado.get(i).getNumFederado()%></a></td>
                        <td class="texto_tablas"><a href="licenBajaResultadoServlet?var=<%=listaFederado.get(i).getIdFederado()%>"><%=listaFederado.get(i).getNombre()%></a></td>
                        <td class="texto_tablas"><a href="licenBajaResultadoServlet?var=<%=listaFederado.get(i).getIdFederado()%>"><%=listaFederado.get(i).getApellido1()%></a></td>
                        <td class="texto_tablas"><a href="licenBajaResultadoServlet?var=<%=listaFederado.get(i).getIdFederado()%>"><%=listaFederado.get(i).getApellido2()%></a></td>
                        <td class="texto_tablas"><a href="licenBajaResultadoServlet?var=<%=listaFederado.get(i).getIdFederado()%>"><%=listaFederado.get(i).getDni()%></a></td>
                    </tr>
