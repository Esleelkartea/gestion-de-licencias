...
<div id="contenedor">
	...
	<h1><img src="imagenes/carpeta.gif" width="30" height="30" /> Baja Federado</h1>
       ...
       <%
           ...
           TipoBaja razonBaja = (TipoBaja)session.getAttribute("razonBaja");
       %>
	...
	<div class="formulario_dobles_campos">
    	...
    	<img src="imagenes/lapiz.gif" width="16" height="16" />Baja</div>
  		<div class="msg_body_gris">
            ...
            <form autocomplete="off" action="licenBajaMIBServlet" method="post">

            <input type="hidden" id="idFederado" name="idFederado" value="<%=unFederado.getIdFederado()%>" />


             <div class="formulario_formato">
                <div class="formulario_dobles">Razon Baja: </div>
                <div class="formulario_dobles_campos">
                    <label><%=razonBaja.getRazon()%></label>
                </div>
            </div>
                ...
                <div class="formulario_formato">
                <div class="formulario_dobles">¿Estas seguro que quieres dar de baja? </div>
                </div>

                <div class="formulario_botones">
                    <label><input name="enviar" type="submit" class="boton" id="alta" value="Confirmar"></label>
