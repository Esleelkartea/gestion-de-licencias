...
<div id="contenedor">
	...
	<h1><img src="imagenes/carpeta.gif" width="30" height="30" /> Alta Consulta </h1>
    	...
    	<img src="imagenes/lapiz.gif" width="16" height="16" />El Alta de la Consulta se ha realizado correctamente.</div>
  		<div class="msg_body_gris">

            <form autocomplete="off" action="consultaCorrectaServlet" method="post">
