 ...
 <script type="text/javascript">
    ...
    function validar()
    {
        ...
        else
        {
            ...
            {
                alert("Debes introducir una descripcion del Grupo");
                return false;
            }
            else
            {
                ...
                if(letra.length == 0)
                {
                    alert("Debes introducir una letra identificativa");
                    return false;
                }
                else
                {
    ...
    function validarBaja()
    {
        ...
        if (idGrupo.length == 0 || idGrupo == "/")
        {
            alert("Debes seleccionar un Grupo para dar de baja");
            return false;
        }
        else
        {
...
<div id="contenedor">
		...
		<li><a href="http://www.bizkaiagolf.com">WEB</a></li>
         ...
         <div id="submenu">
            <ul id="lista_submenu">
                        ...
                        <li><a id="activo" href="#">Grupos</a></li>
	...
	<h1><img src="imagenes/carpeta.gif" width="30" height="30" /> CONFIGURACI&Oacute;N GRUPOS</h1>
     

           <div class="marco">
  		<div class="msg_head_gris">
    	<img src="imagenes/lapiz.gif" width="16" height="16" />Grupos</div>
	...
	<tr>
            <th class="titulos_tablas">Nombre Grupo</th>
            <th class="titulos_tablas">Letra Licencia</th>
            <th class="titulos_tablas">Descripcion Grupo</th>
        </tr>
	</thead>
        ...
        <tbody>
            ...
            %>
            <tr>
                <td class="texto_tablas"><a href="confGrupoServlet?var=<%=listaGrupos.get(i).getIdGrupo()%>"><%=listaGrupos.get(i).getNombre()%></a></td>
                <td class="texto_tablas"><a href="confGrupoServlet?var=<%=listaGrupos.get(i).getIdGrupo()%>"><%=listaGrupos.get(i).getLetra()%></a></td>
                <td class="texto_tablas"><a href="confGrupoServlet?var=<%=listaGrupos.get(i).getIdGrupo()%>"><%=listaGrupos.get(i).getDescripcion()%></a></td>
            </tr> 
        ...
        if (unGrupo!= null)
        {
            idGrupo = String.valueOf(unGrupo.getIdGrupo());
            nombre = unGrupo.getNombre();
            letra = unGrupo.getLetra();
            descripcion = unGrupo.getDescripcion();
        }
       %>

       <form autocomplete="off" action="confGrupoMIBServlet" method="post">
	...
	<div class="formulario_dobles_campos">
        ...
        <div class="formulario_formato">
	<div class="formulario_dobles">Letra: </div>
	<div class="formulario_dobles_campos">
            <label><input name="letra" type="text" class="campo_texto" id="letra" size="100" value="<%=letra%>" >
	</label></div>
	</div>
	...
	<div class="formulario_dobles_campos">
            ...
            <input type="hidden" id="idGrupo"  name="idGrupo" value=<%=idGrupo%> /><br/>
