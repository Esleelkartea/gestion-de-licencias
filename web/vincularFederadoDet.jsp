...
<div id="contenedor">
	...
	<div class="formulario_dobles_campos">
     ...
     <%
        FederadoColectivo unFederadoColectivo = (FederadoColectivo)session.getAttribute("unFederadoColectivo");
        String strObservaciones = "";
        String strIdFederadoColectivo = "";
        int intIdColectivo = 0;
        int intIdFederado = 0;
        if(unFederadoColectivo != null)
        {
            intIdColectivo = unFederadoColectivo.getColectivo().getIdColectivo();
            intIdFederado = unFederadoColectivo.getFederado().getIdFederado();
            strIdFederadoColectivo = String.valueOf(unFederadoColectivo.getIdFederadoColectivo());
            if(!unFederadoColectivo.getObservaciones().equals(""))
            {
                strObservaciones = unFederadoColectivo.getObservaciones();
            }
     ...
     %>
             ...
             <div class="marco">
  		<div class="msg_head_gris">
    	<img src="imagenes/lapiz.gif" width="16" height="16" />Colectivo vinculado</div>
  		<div class="msg_body_gris">

         <form action="vincularFederadoMIBServlet" autocomplete="off" method="post" >
              
              <div class="formulario_formato">
                <div class="formulario_dobles">Colectivo: </div>
                <div class="formulario_dobles_campos">
                    <label><%=unFederadoColectivo.getColectivo().getNombre()%></label>
                </div>
               </div>
            ...
            <div class="formulario_formato">
                <div class="formulario_dobles">Observaciones: </div>
                    <div class="formulario_dobles_campos">
                        <label><input name="observaciones" type="text" class="campo_texto" id="dni" size="100" value="<%=strObservaciones%>" ></label></div>
            </div>

            <input type="hidden" name="idFederadoColectivo" value="<%=strIdFederadoColectivo%>" />
            <input type="hidden" name="idFederado" value="<%=intIdFederado%>" />
            <input type="hidden" name="idColectivo" value="<%=intIdColectivo%>" />

            <div class="formulario_botones">
                <label><input name="enviar" type="submit" class="boton" id="alta" value="Modificar" onclick="validarModificacion()" >
            </label>
                <label><input name="enviar" type="submit" class="boton" id="alta" value="Eliminar" >
            </label>
