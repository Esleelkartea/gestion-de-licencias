...
<div id="contenedor">
	...
	<h1><img src="imagenes/carpeta.gif" width="30" height="30" /> PENDIENTES</h1>
        ...
        <%
            ArrayList<FederadoConsulta> listaFederadoConsultas = (ArrayList<FederadoConsulta>)session.getAttribute("listaFederadoConsultas");
            if(listaFederadoConsultas != null)
            {
        %>
  		...
  		<div class="msg_head_gris">
                <img src="imagenes/lapiz.gif" width="16" height="16" />Consultas Pendientes</div>
  		<div class="msg_body_gris">

            <%
            if(listaFederadoConsultas.size() == 0)
            {
            %>
                <div class="msg_head_gris">No hay ninguna Consulta Pendiente</div>
            <%
            }
            else
            {
               ...
               <div class="capas_tablas_mm">
                ...
                <tbody>
                    ...
                    <% if (listaFederadoConsultas != null)
                       {
                            String fecha;
                            for (int i = 0; i<listaFederadoConsultas.size(); i++)
                            {
                                fecha = String.valueOf(listaFederadoConsultas.get(i).getFechaConsulta());
                                String[] arrFecha = fecha.split("-");
                                fecha = arrFecha[2] + "-" + arrFecha[1] + "-" + arrFecha[0];
                    %>
                    <tr>
                        <td class="texto_tablas"><a href="consultaPendienteDetServlet?var=<%=listaFederadoConsultas.get(i).getIdFederadoConsulta()%>"><%=listaFederadoConsultas.get(i).getFederado().getNumFederado()%></a></td>
                        <td class="texto_tablas"><a href="consultaPendienteDetServlet?var=<%=listaFederadoConsultas.get(i).getIdFederadoConsulta()%>"><%=listaFederadoConsultas.get(i).getFederado().getNombre()%></a></td>
                        <td class="texto_tablas"><a href="consultaPendienteDetServlet?var=<%=listaFederadoConsultas.get(i).getIdFederadoConsulta()%>"><%=listaFederadoConsultas.get(i).getFederado().getApellido1()%></a></td>
                        <td class="texto_tablas"><a href="consultaPendienteDetServlet?var=<%=listaFederadoConsultas.get(i).getIdFederadoConsulta()%>"><%=listaFederadoConsultas.get(i).getFederado().getApellido2()%></a></td>
                        <td class="texto_tablas"><a href="consultaPendienteDetServlet?var=<%=listaFederadoConsultas.get(i).getIdFederadoConsulta()%>"><%=listaFederadoConsultas.get(i).getFederado().getDni()%></a></td>
                        <td class="texto_tablas"><a href="consultaPendienteDetServlet?var=<%=listaFederadoConsultas.get(i).getIdFederadoConsulta()%>"><%=listaFederadoConsultas.get(i).getConsulta().getConsulta()%></a></td>
                        <td class="texto_tablas"><a href="consultaPendienteDetServlet?var=<%=listaFederadoConsultas.get(i).getIdFederadoConsulta()%>"><%=fecha%></a></td>
                    </tr>
