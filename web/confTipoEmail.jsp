...
<link href="estilos/estilos.css" rel="stylesheet" type="text/css" />
 ...
 <script type="text/javascript">
    ...
    function validar()
    {
        ...
        {
            alert("Debes introducir un Tipo de Email");
            return false;
        }
        else
        {
    ...
    {
        var idTipoEmail = document.getElementById("idTipoEmail").value;
        if (idTipoEmail.length == 0 || idTipoEmail == "/")
        {
            alert("Debes seleccionar un Tipo de Email para dar de baja");
            return false;
        }
        else
        {
...
<div id="contenedor">
		...
		<li><a href="http://www.bizkaiagolf.com">WEB</a></li>
         ...
         <div id="submenu">
            <ul id="lista_submenu">
                        ...
                        <li><a id="activo" href="#">Tipo email</a></li>
	...
	<h1><img src="imagenes/carpeta.gif" width="30" height="30" /> CONFIGURACI&Oacute;N TIPOS EMAIL</h1>
     

           <div class="marco">
  		<div class="msg_head_gris">
    	<img src="imagenes/lapiz.gif" width="16" height="16" />Tipos Email</div>
	...
	<tr>
            <th class="titulos_tablas">Tipo Email</th>
        </tr>
	</thead>
        ...
        <tbody>
            ...
            %>
            <tr>
                <td class="texto_tablas"><a href="confTipoEmailServlet?var=<%=listaTipoEmail.get(i).getIdTipoEmail()%>"><%=listaTipoEmail.get(i).getTipo()%></a></td>
            </tr> 
        ...
        <%
        TipoEmail unTipoEmail = (TipoEmail)session.getAttribute("unTipoEmail");
        String idTipoEmail = "";
        String tipo = "";

        if (unTipoEmail != null)
        {
            idTipoEmail = String.valueOf(unTipoEmail.getIdTipoEmail());
            tipo = unTipoEmail.getTipo();
        }
       %>

       <form autocomplete="off" action="confTipoEmailMIBServlet" method="post">
           
	<div class="formulario_formato">
	<div class="formulario_dobles">Tipo Email: </div>
	<div class="formulario_dobles_campos">
            ...
            <input type="hidden" id="idTipoEmail"  name="idTipoEmail" value=<%=idTipoEmail%> /><br/>
