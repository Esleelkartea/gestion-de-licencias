 ...
 * @author Julen
 */
public class confDEBusquedaMIBServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try
        {
            ...
            listaDEActividad = deActividadDAL.getDEActividad(-1, -1, Integer.parseInt(strCurso), Integer.parseInt(strEntidad), null, null, null);
           
            request.getSession().setAttribute("listaDEActividad", listaDEActividad);

        }
        finally
        {
            getServletContext().getRequestDispatcher("/DEResultado.jsp").forward(request, response);
            out.close();
        }
    } 
