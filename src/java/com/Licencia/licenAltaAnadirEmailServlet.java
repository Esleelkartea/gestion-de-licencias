 ...
 * @author Julen
 */
public class licenAltaAnadirEmailServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try
        {
            ...
            String strTipoEmail = request.getParameter("tipoEmail");
            String strEmail = request.getParameter("email");
            TipoEmail unTipoEmail = null;
            TipoEmailDAL tipoEmailDAL = new TipoEmailDAL();
            unTipoEmail = tipoEmailDAL.getTipoEmail(Integer.parseInt(strTipoEmail));

            FederadoEmail unFederadoEmail = new FederadoEmail(strEmail, unTipoEmail, 0);

            if(listaFederadoEmail == null)
            {
                listaFederadoEmail = new ArrayList<FederadoEmail>();
            }
            listaFederadoEmail.add(unFederadoEmail);

            request.getSession().setAttribute("listaFederadoEmail", listaFederadoEmail);
