 ...
 * @author Julen
 */
public class licenAltaAnadirTelefonoServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try
        {
            ...
            String strTipoTelefono = request.getParameter("tipoTelefono");
            ...
            unTipoTelefono = tipoTelefonoDAL.getTipoTelefono(Integer.parseInt(strTipoTelefono));

            FederadoTelefono unFederadoTelefono = new FederadoTelefono(strTelefono, unTipoTelefono, 0);

            if(listaFederadoTelefono == null)
            {
                listaFederadoTelefono = new ArrayList<FederadoTelefono>();
            }
            listaFederadoTelefono.add(unFederadoTelefono);

            request.getSession().setAttribute("listaFederadoTelefono", listaFederadoTelefono);
