 ...
 * @author Julen
 */
public class licenBusquedaBaja2Servlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try
        {
            ...
            listaFederado = federadoDAL.getFederadoBusquedaBaja(-1, strNumFederado, strNombre, strApellido1, strApellido2, strDNI, Integer.parseInt(strEntidad), dFechaInicio, dFechaFin);
