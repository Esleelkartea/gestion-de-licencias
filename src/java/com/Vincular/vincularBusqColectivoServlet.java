 ...
 * @author Julen
 */
public class vincularBusqColectivoServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        {
             getServletContext().getRequestDispatcher("/vincularColectivoResultado.jsp").forward(request, response);
             out.close();
        }
    } 
