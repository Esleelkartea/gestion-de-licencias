 ...
 * @author Julen
 */
public class vincularBusquedaServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        finally
        {
            ...
            request.getSession().setAttribute("listaFederados", null);

            getServletContext().getRequestDispatcher("/vincularBusqueda.jsp").forward(request, response);
            out.close();
        }
    } 
