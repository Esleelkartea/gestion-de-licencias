 ...
 * @author Julen
 */
public class vincularColectivoMIBServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try
        {
            ...
            {
                federadoColectivoDAL.eliminarFederadoColectivo(Integer.parseInt(strIdFederado), Integer.parseInt(strIdColectivo));
                getServletContext().getRequestDispatcher("/vincularBusquedaCorrecta.jsp").forward(request, response);
                return;
