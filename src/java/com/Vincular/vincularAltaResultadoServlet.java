 ...
 * @author Julen
 */
public class vincularAltaResultadoServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        {
            getServletContext().getRequestDispatcher("/vincularAltaResultado.jsp").forward(request, response);
            out.close();
        }
    } 
