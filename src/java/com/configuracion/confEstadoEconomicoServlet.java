 ...
 * @author Julen
 */
public class confEstadoEconomicoServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try
        {
            ...
            EstadoEconomico unEstadoEconomico;
            if(request.getParameter("var")!=null)
            {
               String idEstadoEconomico = request.getParameter("var");
               unEstadoEconomico = estadoEconomicoDAL.getEstadoEconomico(Integer.parseInt(idEstadoEconomico));
               request.getSession().setAttribute("unEstadoEconomico", unEstadoEconomico);
            }
            else
            {
               request.getSession().setAttribute("unEstadoEconomico", null);
            }
        }
        finally
        {
            request.getSession().setAttribute("listaEstadoEconomico", listaEstadoEconomico);
            getServletContext().getRequestDispatcher("/confEstadoEconomico.jsp").forward(request, response);
            out.close();
        }
    } 
