 ...
 * @author Julen
 */
public class confPlantillaEmailAltaServlet extends HttpServlet {
        ...
        try
        {
           ...
           if (part.isParam())
           {
            ...
            else if (part.isFile()) //es el fichero??
            {
                ...
                dirUploadFiles = sc.getRealPath("archivos/email");
                File archivo = new File( dirUploadFiles, nombreFichero );
                filePart.writeTo(archivo);
                url="archivos/email/"+nombreFichero;

            }
          }
           plantillaEmailDAL.insertarPlantillaEmail(nombre, url);
