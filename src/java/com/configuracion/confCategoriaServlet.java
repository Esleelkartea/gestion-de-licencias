 ...
 * @author Julen
 */
public class confCategoriaServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try
        {
            listaCategorias = categoriaDAL.getCategoria(-1, null, null, null, -1, -1);
        ...
        finally
        {
            ...
            getServletContext().getRequestDispatcher("/confCategorias.jsp").forward(request, response);
            out.close();
        }
    } 
